...
const Banking = () => {
  ...
  const Excutivedelete = async () => {
    try {
      ...
      const response = await axios.post(
        'https://lunarsenterprises.com:5016/crm/delete/bank-details',
        del,
  ...
  const Customerview = (bd_id) => {
    Navi(`/dashboard/Banking/Bankingview/${bd_id}`)
  }
  ...
  return (
    <>
            ...
            <div className="spacemanger ">
              ...
              <div className="d-md-flex justify-content-end align-items-center col-md-4">
                <Button className="mb-3 bgaditem" type="submit" onClick={handleShow}>
                  <i className="fa fa-plus" aria-hidden="true"></i> Add New Bank
                </Button>
                  ...
                  {loading ? (
                    ...
                    products.map((account, index) => (
                      <tr key={account.bd_id}>
                        ...
                        <td>{account.bd_acc_type}</td>
                        <td>{account.bd_acc_name}</td>
                        <td>{account.bd_acc_code}</td>
                        <td>{account.bd_acc_currency}</td>
                        <td>{account.bd_acc_number}</td>
                        <td>{account.bd_acc_bank_name}</td>
                        <td>{account.bd_acc_ifsc}</td>
                        {/* <td>{account.bd_acc_description}</td> */}
                        {/* <td>
                          {account.bd_acc_primary === "1" ? (
                        ...
                        <td>
                          <Badge bg={account.bd_acc_status === 'active' ? 'info' : 'danger'}>
                            {account.bd_acc_status}
                          </Badge>
                        </td>
                        <td className="">
                          <Button
                            onClick={(e) => {
                              e.stopPropagation()
                              handleDeleteConfirmation(account.bd_id)
                            }}
                          >
                            <FontAwesomeIcon
                              icon={faTrash}
                              ...
                              onClick={(e) => {
                                ...
                                handleDeleteConfirmation(account.bd_id) // Show modal for deletion
                              }}
                            />
                          </Button>
                        </td>
                        ...
                        <td className="">
                          ...
                          >
                            <FontAwesomeIcon
                              ...
                              style={{ cursor: 'pointer' }}
                              onClick={() => {
                                Customerview(account.bd_id) // Show modal for deletion
                              }}
                            />
                          </Button>
                        </td>
          ...
          <>
            <div className="banking-container">
              ...
              <p>
                ...
                categorize and match these transactions to those you have in AIMS Books.
              </p>
              <div className="button-group">
                {/* <button className="connect-button">Connect Bank / Credit Card</button> */}
                <button className="connect-button">
                  <a href="/dashboard/Banking/Addbanking" className="text-white">
                    ADD MANUALLY 
                  </a>
                </button>
              </div>
      ...
      <Modal show={showDeleteModallist} onHide={handleCloseDeleteModal}>
        ...
        <Modal.Body>Are you sure you want to delete this Bank Details?</Modal.Body>
        <Modal.Footer>
