    ...
    },
    {
      ...
      render: (_, record) => (
        <Controller
          ...
          control={control}
          rules={{ required: 'Select Your Product' }}
          render={({ field }) => (
            <Select
              {...field}
              value={record.item }
...

    {
      ...
      render: (_, record) => (
        <Controller
          name={`ac-${record.ac}`}
          control={control}
          rules={{ required: 'Select a Account' }}
          render={({ field }) => (
            <Select
              {...field}
              value={record.ac }
            ...
            >
              {  bankdetails.length === 0 && (
                <Option value="Select a Account">Select Your Account</Option>
              )}
            </Select>
          )}
        />
...
export default TablePurchasesorder
