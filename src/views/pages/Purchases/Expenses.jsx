...
const Expenses = () => {
  ...
  const handleShow = () => {
    Navi('/dashboard/Expenses/Addexpense')
  }
  const Customerview = (ep_id) => {
    Navi(`/dashboard/Expenses/Editexpense/${ep_id}`)
  }
  // Handle Page Change
  ...
  return (
    <>
            ...
            <div className="spacemanger ">
              ...
              <div className="d-md-flex justify-content-end align-items-center col-md-4">
                <Button className="mb-3 bgaditem" type="submit" onClick={handleShow}>
                  <i className="fa fa-plus" aria-hidden="true"></i> Add New Expenses
                </Button>
                ...
                <tbody className="tablehead">
                  {loading ? (
                    ...
                    products?.map((account, index) => (
                      <tr key={account.ep_id}>
                        <td className="tablehead me-3"> {(currentPage - 1) * limit + index + 1}</td>
                        {/* <td>{account.ep_employee_id}</td>

                        <td>{account.ep_employee_name}</td> */}
                        <td>{account.ep_vendor_name}</td>
                        <td>{account.so_customer_notes}</td>

                        <td>{moment(account.ep_date).format('DD-MM-YYYY')}</td>

                        <td>{account.ep_paid_through}</td>

                        <td>
                          <Badge bg={account.ep_status === 'active' ? 'info' : 'danger'}>
                            {account.so_status}
                          </Badge>
                        </td>
                        <td className="btn-deleteview">
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation()
                              handleDeleteConfirmation(account.ep_id)
                            }}
                          >
                            <FontAwesomeIcon
                              icon={faTrash}
                              ...
                              onClick={(e) => {
                                ...
                                handleDeleteConfirmation(account.ep_id) // Show modal for deletion
                              }}
                            />
                          </Button>
                        </td>
                        ...
                        <td className="">
                          ...
                          >
                            <FontAwesomeIcon
                              ...
                              style={{ cursor: 'pointer' }}
                              onClick={() => {
                                Customerview(account.ep_id) // Show modal for deletion
                              }}
                            />
                          </Button>
                        </td>
            ...
            <div className="banking-container">
              ...
              <div className="button-group">
                <button className="connect-button">
                  <a href='/dashboard/Expenses/Addexpense' className='text-white'>
                   ADD NEW EXPENSE
                   </a>
                   </button>
                {/* <button className="add-manually-button">Add Manually</button> */}
              </div>
              {/* <p className="skip-link">Import Expenses </p> */}
                  ...
                  products?.map((account, index) => (
                    <tr key={account.ep_id}>
                      ...
                      <td>
                        ...
                        <Badge className='pb-2 text-capitalize'>
                        {account.ep_paid_through}
                        </Badge>

                      </td>

                      <td>
                        <Badge className='text-capitalize' bg={account.ep_status === 'active' ? 'info' : 'danger'}>
                          {account.ep_status}
                        </Badge>
                      </td>
      ...
      <Modal show={showDeleteModallist} onHide={handleCloseDeleteModal}>
        ...
        <Modal.Body>Are you sure you want to delete this Expenses ?</Modal.Body>
        <Modal.Footer>
