...
const InvoiceForm = () => {
  ...
  const handleChangeradio = (setter) => (e) => setter(e.target.value);
  ...
  const [currentDate, setCurrentDate] = useState(() => {
    return new Date().toISOString().split("T")[0]; // Outputs "YYYY-MM-DD"
  });
  ...
  return (
    <>
            ...
            <Card className="p-4 p-xl-5 my-3 my-xl-4">
              ...
              {documentType === "Quote" && (
                <>
                  ...
                  {/* <Row> */}
                  {/* <Col md={6}>
                      <Form.Label className="fw-bold">Quote Date:</Form.Label>
                      <Form.Control
                        type="date"
                        value={quoteDate}
                        onChange={handleChange(setQuoteDate)}
                        required
                      />
                    </Col> */}
                  {/* <Col md={6}>
                    ...
                    <Select
                      ...
                      onChange={(selectedOption) => {
                        if (selectedOption.value === "add_new") {
                          handleAddNewCustomer(); // Handle adding a new customer
                        } else {
      ...
      {/* <p className="mt-3">
        <strong>Current Status:</strong> {selectedStatus.label}
      </p> */}
    </div>
              <Row className="mb-5 mt-3">
                <Col>
                  ...
                  <Form.Label className="fw-bold">Bill Address:
                  </Form.Label>

        <FaEdit style={{ marginLeft: "8px", cursor: "pointer", color: "blue" }}
...
Phone: ${viewcustom[0]?.cu_b_addr_phone || ""}`}
                ...
                <Col>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <Form.Label className="fw-bold">Shipping Address:
                  </Form.Label>
