...
const AddDeliverychallansContextview = createContext()

export const AddDeliverychallansProviderview = ({ children }) => {
  ...
  return (
    <AddDeliverychallansContextview.Provider
      value={{
        productslist,
        setProductslist,
        accountType,
...
export const useAddDeliverychallansview = () => useContext(AddDeliverychallansContextview)
